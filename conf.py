...
BLOG_AUTHOR = "Jack Marshall"  # (translatable)
BLOG_TITLE = "Multimodal Experiment Project"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://JMphoneexperiment.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://JMphoneexperiment.com/"
BLOG_EMAIL = "jackbmarshall@outlook.com"
BLOG_DESCRIPTION = "This project details my experiences with attempting to get away from phone useage for a week"  # (translatable)
...
GITHUB_REMOTE_NAME = 'JackMarsh1l.github.io'
